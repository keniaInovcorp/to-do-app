                ...
                <form action="{{ route('tasks.update', $task) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description"
                                  ...
                                  rows="4"
                                  placeholder="Adicione uma descrição detalhada...">{{ old('description', $task->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <select name="status"
                                class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('status') border-red-500 @else border-gray-300 @enderror"
                                required>
